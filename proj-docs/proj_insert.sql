...
insert into Chef values ('chef1', 'omgitzme', 100000, 234213205);

insert into Chef values ('Wewic', 'omgitzme', 150405, 234013005);
...
insert into Menuitem values ('Shrimp Fried Rice', 11.00, 'http://', 'Egg fried rice with shrimps', 3, 'F');

insert into Menuitem values ('Deluxe Burger', 8.95, 'http://', 'Hamburger with lettuce, tomato, pickles, and a beef patty', 5, 'F');

insert into Menuitem values ('Ice cream ramen', 5.23, 'http://', 'Noodles in a cone!', 10, 'F');

insert into Menuitem values ('Beef smoothie', 6.21, 'http://', 'A healthy blend of greens and beef to ensure you hit your protein macros.', 1, 'F');

insert into Menuitem values ('Deep fried protein powder', 18.43, 'http://', 'Anything is better deep fried!', 15, 'F');


insert into Ingredient values ('Lettuce', 'F');

insert into Ingredient values ('Tomato',  'F');

insert into Ingredient values ('Burger Buns', 'F');

insert into Ingredient values ('Beef Patty', 'F');

insert into Ingredient values ('Rice',  'F');

insert into Ingredient values ('Egg',  'F');

insert into Ingredient values ('Shrimp', 'F');

insert into Ingredient values ('Ramen', 'F');

insert into Ingredient values ('Ice cream', 'F');

insert into Ingredient values ('Protein', 'F');
